...
# adicionar os outros mat e flu ......

# parâmetros do processo de estampagem
estampa = simulation.stamping(Tinitial=100, Tstamp=800, forma='anel circular')
...
simulacao1 = simulation.DiffFin(chapa, cobre, armov, estampa, conv)   # ARGUMENTOS:
simulacao2 = simulation.DiffFin(chapa, ouro,  armov,  estampa, conv)  #  1. geommetria
simulacao3 = simulation.DiffFin(chapa, ferro, armov, estampa, conv)   #  2. material 3. fluido
simulacao4 = simulation.DiffFin(chapa, bronze, armov,  estampa, conv) #  4. estampagem 5. convecção
